---
name: ideal-init
description: Use when initializing a new project to CC-Workflow, migrating an existing project, or user mentions "初始化项目", "接入工作流", "/ideal-init". Sets up global agents/skills and creates project-level configuration.
---
...
digraph init_workflow {
    ...
    start [label="用户触发 init"];
    step1 [label="1. 确认目标路径"];
    step2 [label="2. 检查全局配置\n~/.claude/"];
    step3 [label="3. 安装/更新全局资源"];
    step4 [label="4. 探测项目信息"];
    step5 [label="5. 用户确认/修正"];
    step6 [label="6. 扫描已有结构"];
    step7 [label="7. 处理冲突文件"];
    step8 [label="8. 生成项目结构"];
    step9 [label="9. 输出初始化报告"];
    done [label="完成"];
