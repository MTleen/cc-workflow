...
| P13 | 人工评审 | 全部文档 | 上线许可 | - |
| P14 | CI/CD | 代码 | 生产环境 | - |
| P15 | `ideal-wiki` | 代码 + P1 文档 | Wiki 文档 | ⏳ 待开发 |
| P16 | 人工评审 | Wiki 文档 | 发布许可 | - |
...
phases:
  ...
  ...
  P16: { status, updated_at, reviewer }
```
...
| P0 | ideal-wiki | P15 维基更新 |
| P1 | ideal-flow-control | 流程状态管理 |

### 8.2 验证场景

选择一个简单功能（如"用户登录"），完整跑通 P1-P16 流程：
